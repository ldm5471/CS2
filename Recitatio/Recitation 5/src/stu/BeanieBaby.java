...
public class BeanieBaby implements Comparable<BeanieBaby> {
    ...
    public boolean equals(Object other) {
        if (other instanceof BeanieBaby){
            BeanieBaby baby = (BeanieBaby) other;
            return this.name.equals(baby.name) && this.year == baby.year && this.type == baby.type;
        }else {
            return false;
        }
    }
    ...
    public int hashCode() {
        ...
        return (int) (this.name.hashCode() + this.year + this.type.hashCode());
    }
}